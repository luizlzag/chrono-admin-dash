...
export const getProductStockInGym = async (productId, gymId) => {
  try {
    ...
    console.error(
      `Erro ao buscar estoque para produto ID ${productId} e academia ID ${gymId}:`,
      error
    )
    throw error
  }
...
export const updateProductStock = async (productId, newStock) => {
  try {
    ...
    console.error(
      `Erro ao atualizar estoque para produto ID ${productId}:`,
      error
    )
    throw error
  }
...
export const transferProductStock = async (
  productId,
  fromGymId,
  toGymId,
  quantity
  ...
  try {
    ...
    console.error(
      `Erro ao transferir estoque para o produto ${productId}:`,
      error
    )
    throw error
  }
...
export const updateTransaction = async (transactionId, updatedData) => {
  try {
    ...
    console.error(
      `Erro ao atualizar a transação com ID ${transactionId}:`,
      error
    )
    throw error
  }
...
export const getGroupedAdminTransactions = async (filters) => {
  try {
    ...
    const response = await api.get(
      `/admin/transactions/grouped?${queryParameters}`
    )
    return response.data
  } catch (error) {
    console.error('Erro ao buscar transações:', error)
...
export const payTransactionComission = async (transactionId, gymId) => {
  try {
    const response = await api.post(
      `/admin/transaction/comission/pay/${transactionId}`,
      {
        gymId
      }
    )
    ...
    console.error(
      `Erro ao pagar a comissão da transação com ID ${transactionId}:`,
      error
    )
    throw error
  }
