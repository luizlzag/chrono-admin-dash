...
function ListSells() {
    ...
    const subtotalAmount = filteredSales.reduce(
        (sum, sale) => sum + sale.total,
        0
    )
    const subtotalQuantity = filteredSales.reduce(
                ...
                <div className="flex gap-4 mb-4">
                    ...
                    <div>
                        ...
                        >
                            ...
                            {[
                                ...new Set(
                                    sales.map((sale) => sale.product.name)
                                )
                            ].map((product, index) => (
                    ...
                    <div>
                        ...
                        <select
                            onChange={(e) =>
                                handleFilterChange('gym', e.target.value)
                            }
                            className="p-2 border border-gray-300 rounded"
                        >
                            <option value="">Todas</option>
                            {[
                                ...new Set(sales.map((sale) => sale.gym.name))
                            ].map((gym, index) => (
